...
from hashorb.config import DEFAULT_COMPUTE_WORKERS, MAX_COMPUTE_WORKERS
from hashorb.mining.search import NonceSearchResult, PreparedMiningWork, _validate_nonce_range
...
def _create_executor(worker_count: int) -> Executor:
    return ThreadPoolExecutor(
        ...
        thread_name_prefix="hashorb-native",
    )
