...
from hashorb.bitcoin.serialization import encode_compact_size
from hashorb.bitcoin.template import BlockTemplate
from hashorb.bitcoin.transaction import MAX_MONEY, ParsedTransaction, parse_transaction
...
HASHORB_COINBASE_MARKER = b"/HashOrb/"
